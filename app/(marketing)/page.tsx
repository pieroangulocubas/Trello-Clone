    ...
    return (
        <div className="flex items-center justify-center flex-col">
            <div className={cn("flex items-center justify-center flex-col",headingFont.className)}> 
                ...
                <div className='text-3xl md:text-6xl bg-gradient-to-r from-fuchsia-600 to-pink-600 text-white first-letter px-4 p-2 rounded-md pb-4 w-fit'>
                    work forward.
                </div>
            </div>
            <div className={cn('text-sm md:text-xl text-neutral-400 mt-4 max-w-xs  md:max-w-2xl text-center mx-auto',textFont.className)}>
                ...
                peaks. From high rises to the home office, the way yout team
